...
Version  : 2022.2
Release  : 6
URL      : https://gitlab.gnome.org/GNOME/gi-docgen/-/archive/2022.2/gi-docgen-2022.2.tar.gz
Source0  : https://gitlab.gnome.org/GNOME/gi-docgen/-/archive/2022.2/gi-docgen-2022.2.tar.gz
...
%prep
%setup -q -n gi-docgen-2022.2
cd %{_builddir}/gi-docgen-2022.2
%patch1 -p1
pushd ..
cp -a gi-docgen-2022.2 buildavx2
cp -a gi-docgen-2022.2 buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672174040
