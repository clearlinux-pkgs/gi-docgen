...
Version  : 2024.1
Release  : 10
URL      : https://gitlab.gnome.org/GNOME/gi-docgen/-/archive/2024.1/gi-docgen-2024.1.tar.gz
Source0  : https://gitlab.gnome.org/GNOME/gi-docgen/-/archive/2024.1/gi-docgen-2024.1.tar.gz
...
%prep
%setup -q -n gi-docgen-2024.1
cd %{_builddir}/gi-docgen-2024.1
%patch -P 1 -p1
pushd ..
cp -a gi-docgen-2024.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720030214
